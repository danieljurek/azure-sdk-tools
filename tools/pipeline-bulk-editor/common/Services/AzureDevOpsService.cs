...
namespace PipelineBulkEditor.Common.Services
{
    // TODO: This should probably be broken down by enttity boundaries at some point
    /// <summary>
    ...
    public class AzureDevOpsService
    {
        ...
        /// <summary>
        /// Gets a list of build definitions with the given project and path
        /// prefix
        /// </summary>
        /// <param name="projectName">Name of the project</param>
        /// <param name="pathPrefix">Path prefix</param>
        /// <returns></returns>
        public async Task<IEnumerable<BuildDefinition>> GetBuildDefinitionsAsync(string projectName, string pathPrefix = null)
        {
        ...
        public async Task<BuildDefinition> UpdateBuildDefinitionAsync(BuildDefinition pipeline)
        {
            var client = await GetClientAsync<BuildHttpClient>();
            var result = await client.UpdateDefinitionAsync(pipeline);
            return result;
        }
        ...
        public async Task UpdateTeamAsync(WebApiTeam team)
        {
            var client = await GetClientAsync<TeamHttpClient>();
            await client.UpdateTeamAsync(team, team.ProjectId.ToString(), team.Id.ToString());
        }
        ...
        public async Task<string> GetDescriptorAsync(string id)
        {
            return await GetDescriptorAsync(new Guid(id));
        }
